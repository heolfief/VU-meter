...
//#define UART_DEBUG						// Uncomment this line if you want serial port debug 
...
#define GAIN_MIN				0.8			// Minimal input signal gain
#define GAIN_MAX				10.0		// Maximal input signal gain
...
#define HC595_SER				PD4		    // Data pin (DS) pin location
#define HC595_SCK				PD6			// Shift Clock (SH_CP) pin location
#define HC595_RCK				PD7			// Register Clock (SH_CP) pin location
#define HC595_SCL				PD5			// Serial clear (active LOW) pin location
